...
for t in temperatures:
    model_path = Path('/homes/abazarova/bnn/notebooks/models/long_fcnn_normal_{temp:.3f}/'.format(temp=t))
...
results = {}
results['fcnn'] = (errors, stdevs)

with open('./normal_results_fcnn_OLDLOSS.json', 'w') as file:
